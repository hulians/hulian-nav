    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 ${themeClass} py-8">
      ...
      <div class="home-search-shell relative max-w-xl mx-auto">
        ...
        <div class="home-search-field relative">
          <input type="search" placeholder="搜索书签..." class="search-input-target w-full pl-12 pr-4 py-3.5 rounded-2xl transition-all shadow-lg outline-none focus:outline-none focus:ring-2 ${searchInputClass}" autocomplete="new-password" autocapitalize="none" autocorrect="off" spellcheck="false" inputmode="search" enterkeyhint="search" aria-label="搜索书签" autofocus data-lpignore="true" data-1p-ignore="true" data-bwignore="true" data-form-type="other">
